...
*******************************************************************/
#define RF_FRAME_TIMEOUT(BitRate) (unsigned short)(double)((((double)((uint32_t)RF_BUFFER_SIZE * (uint32_t)8 *((uint32_t)4  + (uint32_t)1)) / (double)((uint32_t)4 * (uint32_t)BitRate)) * (double)128) + (double)1)
...
** Out : value                                                    **
*******************************************************************/
unsigned short ReadRegister(unsigned char address);
...
*******************************************************************/
void ReceiveRfFrame(unsigned char *buffer, unsigned char *size, unsigned char *pReturnCode);
...
** Out : *pReturnCode                                             **
*******************************************************************/
void AutoFreqControl(unsigned char *pReturnCode);
...
** Out  : -                                                       **
*******************************************************************/
//void Wait(unsigned short cntVal);
...
** Out : -                                                        **
*******************************************************************/
void EnableTimeOut(unsigned char enable);
...
** Out : b                                                        **
*******************************************************************/
//unsigned char InvertByte(unsigned char b);
...
** Out : inputByte                                                **
*******************************************************************/
unsigned char SpiInOut (unsigned char outputByte);
